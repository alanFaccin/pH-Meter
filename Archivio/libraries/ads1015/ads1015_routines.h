//Ads1015 library
//Heavly adapted to the pic architecture, less abstracted i2c library and needs of the PH measurement
...
//Acquire ph probe voltage
float GetProbe_voltage(void) {
    //    possible settings:
    //
    //    channel from 0 to 4
    ...
    //Range is fixed
    const unsigned char range = RANGE_0_512V;
    ...
    //Minus sign is because Vsensor and Vref are inverted on the board
