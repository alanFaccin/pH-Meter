/* 
 * I2C library
 * Adapted by Davide Bortolami
 * Based on precedent work of many authors including but not limited to Microchip itself
 */

#ifndef I2CB_H
#define	I2CB_H

//this library was ported from a legacy version and thus it require legacy mode
#include "../legacy/pic16f87_legacy.h"
